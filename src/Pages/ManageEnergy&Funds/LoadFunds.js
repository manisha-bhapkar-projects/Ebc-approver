...
const LoadFunds = (props) => {
  ...
  return (
    <div className="main-pg-content ml-5">
      <h5 class="title-page-content">Load Funds For Account</h5>
      <div className="row">
...
export default connect(null, mapDispatchToProps)(LoadFunds);
